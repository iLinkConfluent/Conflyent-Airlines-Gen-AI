...
function_app1=${function_app1//\"/}
function_app2=${function_app2//\"/}
function_app3=${function_app3//\"/}
...
curl --location https://${function_app2// /}.azurewebsites.net/api/FlightItineraries --header 'Content-Type: application/json' \
--data "$postBody"

curl --location https://${function_app3// /}.azurewebsites.net/api/Gate --header 'Content-Type: application/json' \
--data "$postBody"

curl --location https://${function_app1// /}.azurewebsites.net/api/Passenger --header 'Content-Type: application/json' \
--data "$postBody"
